...
contract('ShkTokenSale', function (accounts) {
    var tokenInstance;
    ...
    it('initializes the contract with the correct values', function () {
        return ShkTokenSale.deployed().then(function (instance) {
    ...
    return ShkToken.deployed().then(function(instance) {
      ...
      return web3.eth.getBalance(tokenSaleInstance.address).then(function(balance) {
